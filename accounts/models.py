...
class WeekCalendar(models.Model):
    ...
    user = models.ManyToManyField(CustomUser, null=True, blank=True, related_name='owner')
    def user_names(self):
...
class Group(models.Model):
    ...
    admin = models.ManyToManyField(CustomUser, null=True, blank=True, related_name='group_admin')
    members = models.ManyToManyField(CustomUser, null=True, blank=True, related_name='group_member')
...
def prepopulate_profile(sender, instance, created, **kwargs):
    if created:
        ...
        uextra=socialAccount.extra_data
